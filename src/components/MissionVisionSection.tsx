import missionIcon from '../assets/icon-medical-cross.svg?react';

const MissionIcon = missionIcon as any;
    ...
    <section className="bg-white">
      <div className="px-4 sm:px-6 md:px-10 lg:px-20 py-12 sm:py-16 md:py-20 lg:py-24 max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          {/* Mission Card */}
          <div
            className="rounded-[20px] p-6 sm:p-8 md:p-10 border-2 transition-all duration-300 hover:shadow-xl"
            style={{
          ...
          >
            ...
            <p
              className="text-[15px] sm:text-[16px] font-medium leading-[1.8]"
            ...
            >
              ...
              We are committed to improving the health and well-being of our community through advanced medical technology, 
              highly skilled specialists, and patient-centered care that treats every individual with dignity and respect.
            </p>
          </div>
        ...
        <div className="mt-12 md:mt-16">
          <h3
            className="text-[20px] sm:text-[24px] font-extrabold leading-[1.2] tracking-[-0.02em] mb-6 text-center"
            style={{ fontFamily: 'var(--font-manrope)', color: 'var(--color-brand-navy)' }}
          >
            Our Core Values
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
            {[
              ...
              <div
                key={value.title}
                className="rounded-[16px] p-5 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
